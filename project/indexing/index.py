...
def get_index_bm(ans):  # Функция, которая делает матрицу из корпуса
...
def get_query_vector_bm(query, vec):
    vector = vec.transform(query).toarray()
    return vector
